...
% IDEA : the proof from mathematicss (ie NL use of logical rules) should be PGFed
% to the cubicaltt terms

% Linguistically, we have basic rules.  We can construct pairs by saying ``first
% ... and ...", the projections are seldom 
% Case expressions (


% Define the function f to be x^2 from N to N
% Define the function f (x) = x^2 from N to N
% Define the function from Nat to Nat as f (x) = x^2
% f of x is x squared
